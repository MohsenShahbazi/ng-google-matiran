...
export class LoginServiceService extends BaseService {
  ...
  loginAuth(userObj: any) {
    ...
    return this._http.post(this._resource.getResourceUrl() + "login", {uname: userObj.uname, upass: userObj.upass},
      {observe: 'response', headers: this.headerOptions});
  }

  setupAuth() {
    return this._http.post(this._resource.getResourceUrl() + "tfa/setup", {}, {observe: 'response'})
  }

  registerUser(userObj: any) {
    return this._http.post(this._resource.getResourceUrl() + "register", {
      uname: userObj.uname,
      upass: userObj.upass
    }, {observe: "response"});
  }
  ...
  getAuth() {
    return this._http.get(this._resource.getResourceUrl() + "tfa/setup", {observe: 'response'});
  }

  deleteAuth() {
    return this._http.delete(this._resource.getResourceUrl() + "tfa/setup", {observe: 'response'});
  }

  verifyAuth(token: any) {
    return this._http.post(this._resource.getResourceUrl() + "tfa/verify", {token}, {observe: 'response'});
  }
}
